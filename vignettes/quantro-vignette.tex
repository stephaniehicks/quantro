...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{matdensity}\hlstd{(p,} \hlkwc{groupFactor} \hlstd{= pd}\hlopt{$}\hlstd{CellType,} \hlkwc{col} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{),} \hlkwc{xlab} \hlstd{=} \hlstr{" "}\hlstd{,}
           \hlkwc{ylab} \hlstd{=} \hlstr{"density"}\hlstd{,} \hlkwc{main} \hlstd{=} \hlstr{"Beta Values"}\hlstd{)}
\hlkwd{legend}\hlstd{(}\hlstr{'top'}\hlstd{,} \hlkwd{c}\hlstd{(}\hlstr{"NeuN_neg"}\hlstd{,} \hlstr{"NeuN_pos"}\hlstd{),} \hlkwc{col} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{),} \hlkwc{lty}\hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{lwd} \hlstd{=} \hlnum{3}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/plot-distributions-density} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{matboxplot}\hlstd{(p,} \hlkwc{groupFactor} \hlstd{= pd}\hlopt{$}\hlstd{CellType,} \hlkwc{col} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{),} \hlkwc{xaxt} \hlstd{=} \hlstr{"n"}\hlstd{,}
           \hlkwc{main} \hlstd{=} \hlstr{"Beta Values"}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/plot-distributions-boxplot} 
