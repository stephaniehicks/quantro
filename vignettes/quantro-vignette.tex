...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'doParallel' was built under R version 3.4.2}}\begin{alltt}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# [quantro] Using a single core (backend: doParallelMC, \\\#\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \  version: 1.0.11).}}\begin{alltt}
\hlstd{qtestPerm}
\end{alltt}
\begin{verbatim}
## quantro: Test for global differences in distributions
